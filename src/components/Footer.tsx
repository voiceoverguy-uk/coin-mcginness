export default function Footer() {
  const socials = [
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/colinmcginnessmusic/',
      icon: (
    ...
    {
      label: 'Spotify',
      href: 'https://open.spotify.com/artist/3RohZ0dNhSc7FzsnZkB1Hc?si=Xkx1qBHPQyK9IWuiJXqATg',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
      label: 'LinkedIn',
      href: 'https://www.linkedin.com/in/colin-mcginness-435a044b/',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
